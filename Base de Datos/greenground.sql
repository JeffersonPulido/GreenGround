...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-10-2021 a las 18:50:11
...
(58, 12, '2021-09-02', 2061, 'cancelado en envio', 12, 16, 1);
...
(31, 16, 12, 'cancelado en envio', 12);
...
(16, 'Naranja Valencia', 0x30, 'crea deliciosas recetas con nuestro producto naranja valencia para compartir en familia.', 2061, 44, '2021-06-27', '2021-06-17', 12),
...
(12, 'jefferson', 'pulido', 'jeffersonpulido55@gmail.com', '654123', '3103977412', 'Dpto, Municipio, Barrio, Direccion de residencia', '0');
...
--
ALTER TABLE `tbcompras`
  MODIFY `IdCompras` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=59;

--
-- AUTO_INCREMENT de la tabla `tbenvios`
--
ALTER TABLE `tbenvios`
  MODIFY `Id_Envios` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;

--
-- AUTO_INCREMENT de la tabla `tbpago`
--
ALTER TABLE `tbpago`
  MODIFY `IdPago` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
...
--
ALTER TABLE `tbusuario`
  MODIFY `usu_id_usuario` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
